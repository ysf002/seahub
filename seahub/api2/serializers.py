...
class AuthTokenSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if login_id and password:
            ...
            if user:
                ...
                if user is None:
                    self._handle_failed_login(username, ip)
    ...
    def _handle_failed_login(self, login_id, ip_addr):
        failed_attempt = incr_login_failed_attempts(username=login_id, ip=ip_addr)
