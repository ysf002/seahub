...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "All records loaded": "Alle Eintr\u00e4ge wurden geladen.",
    "All tags": "Alle Tags",
    ...
    "Click to load more": "Klicken, um mehr zu laden",
    "Clients": "Programm",
    "Close": "Schlie\u00dfen",
    ...
    "Disable SAML user email / password login": "Login mit Benutzername /Passwort f\u00fcr SAML-Benutzer ausschlie\u00dfen",
    ...
    "Do you want to keep the sharing relationships?": "Wollen Sie die Freigabe-Verbindungen beibehalten?",
    "Document": "Dokument",
    ...
    "Enter comment, Shift + Enter for new line, Enter to send": "Geben Sie ein Kommentar ein (Zeilenumbruch mit SHIFT + ENTER; Kommentar absenden mit ENTER)",
    "Enter date": "Datum eingeben",
    "Enter reply, Shift + Enter for new line, Enter to send": "Geben Sie eine Antwort ein (Zeilenumbruch mit SHIFT + ENTER, Kommentar absenden mit ENTER)",
    "Error": "Fehler",
    ...
    "Force user to use SSO login if SAML account is bound": "Anmeldung mit SSO erzwingen, wenn ein SAML-Konto verbunden ist",
    ...
    "Load all": "Alle laden",
    "Loaded 50,000 records.": "50 000 Eintr\u00e4ge wurden geladen.",
    ...
    "New Wiki name": "Name des neuen Wikis",
    ...
    "No share link": "Kein Freigabe-Link",
    ...
    "Please choose a .sdoczip file.": "SDOCZIP-Datei ausw\u00e4hlen",
